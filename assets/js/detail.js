...
(function(){
  ...
  <article class="detail">
    ...
    <div class="detail-info">
      ...
      ${f.video ? (f.video.endsWith('.mp4') ? `<div class="detail-video" style="margin:18px 0;border-radius:14px;overflow:hidden;border:1px solid var(--border)">
        <video src="${f.video}" controls playsinline preload="metadata" style="width:100%;display:block;background:#000"></video>
