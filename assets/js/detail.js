  ...
  <article class="detail">
    ...
    <div class="detail-info">
      ...
      return `<div class="detail-video" style="margin:18px 0;border-radius:14px;overflow:hidden;border:1px solid var(--border);background:#000;max-width:560px">
        <iframe src="https://www.facebook.com/video/embed?video_id=${vid}&width=560&height=314" width="560" height="314" style="border:none;overflow:hidden;display:block;width:100%;max-width:560px;height:auto" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" allowFullScreen="true"></iframe>
      </div>`; })() : ''}
